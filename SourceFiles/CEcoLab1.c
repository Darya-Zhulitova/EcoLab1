 ...
 *
 */
static int16_t ECOCALLMETHOD CEcoLab1_CombSort(/* in */ IEcoLab1Ptr_t me, void* base, size_t num, size_t size, int (*compare)(const void*, const void*)) {
    CEcoLab1* pCMe = (CEcoLab1*)me;
    size_t gap = num;
    int swapped = 1;  // Используем int вместо bool
    size_t i;
